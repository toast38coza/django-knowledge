...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.redirect'
        db.add_column('knowledge_question', 'redirect',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.redirect'
        db.delete_column('knowledge_question', 'redirect')
    ...
    models = {
        ...
        'knowledge.question': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'public'", 'max_length': '32', 'db_index': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'question'", 'max_length': '32', 'db_index': 'True'}),
