...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.content_type'
        db.add_column('knowledge_question', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.object_id'
        db.add_column('knowledge_question', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.type'
        db.add_column('knowledge_question', 'type',
                      self.gf('django.db.models.fields.CharField')(default='private', max_length=32, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.content_type'
        db.delete_column('knowledge_question', 'content_type_id')

        # Deleting field 'Question.object_id'
        db.delete_column('knowledge_question', 'object_id')

        # Deleting field 'Question.type'
        db.delete_column('knowledge_question', 'type')
    ...
    models = {
        ...
        'knowledge.question': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'private'", 'max_length': '32', 'db_index': 'True'}),
